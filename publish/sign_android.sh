...
BUILD_DIR="./platforms/android/app/build/outputs/apk/release";
...
jarsigner -verbose -sigalg SHA1withRSA -digestalg SHA1 -keystore aiming-high.keystore ${BUILD_DIR}/app-release-unsigned.apk alias_name
